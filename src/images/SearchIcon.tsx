...
export const SearchIcon: FC<ISearchIconProps> = (props: ISearchIconProps) => {
    const {width,onClick,height} = props
    return (
        <svg className="search-icon" onClick={onClick} width={width ? width : 30} height={height ? height : 30} viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
